...
container-dump-db:
	sudo docker exec -it mysql bash -c "mysqldump -uroot -pSysControlaPet2018 Morumbichos < app/dump-de-testes-10-2018.sql && mysql -uroot -pSysControlaPet2018 Morumbichos -e 'source /app/dump-de-testes-10-2018.sql'"
